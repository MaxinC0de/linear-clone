            ...
            <nav className="mx-auto flex w-full max-w-357 items-center justify-between px-19.5 text-[13px]">
                <ul className="flex w-full items-center justify-between gap-4">
                    ...
                    <li className="text-tertiary flex items-center justify-between">
                        ...
                        <div className="border-thin mx-2 h-4 w-px"></div>
                        <div className="flex">
                            <Link
                                href="/"
                                className="hover:bg-hovered hover:text-secondary mr-0.5 flex h-8 cursor-pointer items-center justify-center rounded px-3 leading-5 transition-all duration-150"
                            >
                                Log in
                            </Link>
                            <Link
                                href="/"
                                className="text-main bg-primary/95 ml-1 flex h-8 cursor-pointer items-center justify-center rounded px-3 leading-5 transition-all duration-150 hover:bg-white"
                            >
                                Sign up
                            </Link>
                        </div>
